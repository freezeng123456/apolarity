...
For the individual-partial tests, the network has 16 inputs and three
...
the six targets in Table~\ref{tab_individual_t4}. Here $p$ is the derivative
...
\input{tables/t4_individual_partials}
\end{table}

Table~\ref{tab_individual_t4} reports the evaluation times and speedups.
