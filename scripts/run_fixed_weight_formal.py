...
PROTOCOL_ID = "war_realad_fixed_weights_v1"
ENGINE_PROTOCOL_ID = "war_realad_weight_grid_v1"
...
def manifest(tasks: Iterable[str], seconds: float, seeds: tuple[int, ...], *, smoke: bool) -> dict[str, Any]:
    ...
    return {
        ...
        "architecture": {
            "war": {"representation": "native_complex", "activation": "sinh", "backend": "waring_complex_jet", "hidden": 128, "depth": 4},
            "real_tanh_autodiff": {"representation": "real", "activation": "tanh", "backend": "direct_autodiff", "hidden": 128, "depth": 4},
        },
